...
export default function Contact() {
    return (
        <div className='flex flex-col bg-gradient-to-b from-purple-100/50 to-pink-50/0 p-10 py-22 mt-20'>
            ...
            <div className='h-100 w-150 bg-white mx-auto mt-10 border-1 border-pink-300 rounded-2xl flex flex-col p-5'>
                <div className='flex flex-row mt-auto ml-10'>
                ...
                <div className='flex flex-row my-auto ml-10'>
                ...
                <div className='flex flex-row mb-auto ml-10'>
                    <div className='size-20 bg-white border-1 border-pink-400 rounded-full flex cursor-pointer'>
                        <div className=''></div>
                    </div>
                    <div className='ml-5 my-auto'>
